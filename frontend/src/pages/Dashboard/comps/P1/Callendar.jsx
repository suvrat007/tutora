        ...
        <div className="w-full h-full">
            ...
            >
                ...
                <div className="flex-1 min-h-0 overflow-auto text-[#5a4a3c]">
                    <div className="rounded-xl border border-[#e6c8a8] p-3 bg-[#f8ede3] shadow-[0_8px_24px_rgba(0,0,0,0.15)]">
                        <Calendar
                            onChange={setValue}
                            value={value}
                ...
                <motion.button
                    ...
                    className="mt-4 w-full bg-[#e0c4a8] hover:bg-[#d8bca0] text-[#5a4a3c] py-2 rounded-xl text-sm font-medium tracking-wide shadow-md transition-all duration-300 inline-flex items-center justify-center gap-2"
                >
                    <motion.span
                        whileHover={{ scale: 1.2 }}
                        transition={{ duration: 0.3 }}
                    >
                        <AiOutlinePlus className="text-[#5a4a3c] text-lg" />
                    </motion.span>
