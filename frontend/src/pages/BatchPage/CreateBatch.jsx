...
const CreateBatch = ({ onClose, onBatchCreated ,setRerender }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axiosInstance.post('/add-new-batch', batchData);
            ...
            <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in">
                ...
                <div className="p-4 space-y-6 max-h-[75vh] overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1">Standard / Grade (numeric value only)*</label>
                            <input
                                type="text"
                                name="forStandard"
