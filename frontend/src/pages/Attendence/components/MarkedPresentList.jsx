                        ...
                        <AnimatePresence>
                            {markedPresentStudents.map((s, i) => (
                                <motion.div
                                    ...
                                    initial="hidden"
                                    animate="visible"
                                    className="border border-[#34C759] bg-[#e6f4ea] p-3 rounded-md mb-2 flex justify-between items-center hover:bg-[#d4e9d8] transition-all duration-300"
                                >
                  <span className="text-[#5a4a3c]">
                    {i + 1}. {s.name}
                        ...
                        <motion.div
                            ...
                            animate="pulse"
                            className="flex flex-col items-center justify-center h-[70%] w-[90%] text-[#7b5c4b] mt-8"
                        >
