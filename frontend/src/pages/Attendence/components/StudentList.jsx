                        ...
                        <AnimatePresence>
                            {students.map((s, i) => (
                                <motion.div
                                    ...
                                    initial="hidden"
                                    animate="visible"
                                    className="border border-[#e6c8a8] p-3 rounded-md mb-2 flex justify-between items-center hover:bg-[#f0d9c0] transition-all duration-300"
                                >
                  <span className="text-[#5a4a3c]">
                    {i + 1}. {s.name}
                        ...
                        <motion.div
                            variants={placeholderVariants}
                            animate="pulse"
                            className="flex flex-col items-center justify-center h-[60%] text-[#7b5c4b] mt-8"
                        >
