...
const MobileNavItem = ({ icon, to, label }) => {
  return (
      <Link to={to} className="flex flex-col items-center text-[#4a3a2c] hover:text-[#6b4c3b] text-xs">
...
const MobileNavDropdown = ({ icon, label, isOpen, toggle, subItems }) => {
  return (
      <div className="flex flex-col items-center relative">
        <button onClick={toggle} className="flex flex-col items-center text-[#4a3a2c] hover:text-[#6b4c3b] text-xs">
          <div className="text-lg">{icon}</div>
          <span>{label}</span>
