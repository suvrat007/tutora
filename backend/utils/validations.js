...
const signupValidation = Joi.object({
    ...
    institute_info: Joi.object({
        ...
        logo_URL: Joi.string().uri().allow('').messages({
            'string.uri': 'Logo URL must be a valid URL.'
        }),
        instituteEmailId: Joi.string().email({ tlds: { allow: false } }).required().messages({
        ...
        'object.base': 'Institute info is required.'
    }),
});
